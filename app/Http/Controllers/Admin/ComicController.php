...
use App\Http\Requests\ComicControllerRequest;
...
class ComicController extends Controller
{
     ...
     */
    public function validateComic(Request $request){
    ...
    {
        //$modelData = validateComic(Request $request);
        $this->validateComic($request);
